...
jQuery(document).scroll(function(){
  ...
  {   
     ...
     jQuery('.block-menu ul li').css({"border-bottom":"0px","margin":"0px","transition-delay":"0.3s"});
  } else {
     jQuery('.header-position').css({"background":"transparent"});
     jQuery('.block-menu').css({"margin-top":"20px"});
     jQuery('.block-menu ul li').css({"border-bottom":"0px solid #FFF","margin":"0"});
